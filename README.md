...
┌─────────────────────────────────────────────────────────────┐
│  📱 Enter phone number (e.g., 09123456789)                │
│  Press CTRL+C to stop                                      │
└─────────────────────────────────────────────────────────────┘
➜ 09123456789

🚀 Starting attacks on: 09123456789
────────────────────────────────────────────────────────────
⏳ Sending requests every 0.1 seconds...
⚠ Press CTRL+C to stop

[   1] 📤 Sent:  35  ❌ Failed:   3  ⚠ Error:   2  📊 Total: 40
[   2] 📤 Sent:  38  ❌ Failed:   1  ⚠ Error:   1  📊 Total: 40
[   3] 📤 Sent:  40  ❌ Failed:   0  ⚠ Error:   0  📊 Total: 40
[   4] 📤 Sent:  39  ❌ Failed:   1  ⚠ Error:   0  📊 Total: 40
[   5] 📤 Sent:  37  ❌ Failed:   2  ⚠ Error:   1  📊 Total: 40
```
